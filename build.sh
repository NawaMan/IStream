...
function show-help() {
    ...
    echo "  project-version-number: Contains the major and minor version. For example: 1.0 for '1.0.6' version."
    echo "  project-build-number  : Contains the build number. For example: 6 for '1.0.6' version."
